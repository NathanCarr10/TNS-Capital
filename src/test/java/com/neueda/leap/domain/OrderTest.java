...
class OrderTest {
    ...
    class OrderSideSymbolTests {
        ...
        void testOrdersWithDifferentSymbols() {
            Order aapl = new Order(1L, "AAPL", OrderSide.BUY, 100, new BigDecimal("150.50"), "ID-1");
            Order msft = new Order(1L, "MSFT", OrderSide.BUY, 100, new BigDecimal("300.75"), "ID-2");
    ...
    class OrderUniquenessTests {
        ...
        void testOrdersHaveUniqueIds() {
            ...
            Order order2 = new Order(1L, "AAPL", OrderSide.BUY, 100, new BigDecimal("150.50"), "ID-2");
        ...
        void testIdempotencyKeyDifferentiatesOrders() {
            Order order1 = new Order(1L, "AAPL", OrderSide.BUY, 100, new BigDecimal("150.50"), "ID-SAME-1");
            Order order2 = new Order(1L, "AAPL", OrderSide.BUY, 100, new BigDecimal("150.50"), "ID-SAME-2");
