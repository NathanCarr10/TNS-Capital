...
class BuyOrderStrategyTest {
    ...
    void setUp() {
        ...
        // Initialize strategy with positions map
    ...
    class PositionCreationTests {
        ...
        void testPositionKeyFormat() {
            ...
            Account specialAccount = new Account("ACC042", "Special", new BigDecimal("50000.00"), testClock);

            buyStrategy.execute(specialAccount, buyRequest, "MSFT");

            String expectedKey = "42::MSFT";
            assertTrue(positions.containsKey(expectedKey),
    ...
    class PositionUpdateTests {
        ...
        void testBuySameSymbolUpdatesPosition() {
            ...
            String positionKey = "1::AAPL";
            Position positionAfterBuy1 = positions.get(positionKey);
            ...
            Position positionAfterBuy2 = positions.get(positionKey);
        ...
        void testBuyDifferentSymbolsCreateSeparatePositions() {
            ...
            Position aaplPosition = positions.get("1::AAPL");
            Position msftPosition = positions.get("1::MSFT");
    ...
    class EdgeCaseTests {
        ...
        void testBuyMinimumQuantity() {
            ...
            Position position = positions.get("1::AAPL");
        ...
        void testBuyLargeQuantity() {
            ...
            Account richAccount = new Account("ACC-RICH", "Rich Trader", new BigDecimal("20000000.00"), testClock);
