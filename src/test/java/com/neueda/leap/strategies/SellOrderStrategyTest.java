...
class SellOrderStrategyTest {
    ...
    void setUp() {
        ...
        sellStrategy = new SellOrderStrategy(positions);
        buyStrategy = new BuyOrderStrategy(positions);
    }
    ...
    class PositionRemovalTests {
        ...
        void testPositionRemovedWhenFullySold() {
            ...
            assertTrue(positions.containsKey(positionKey), "Position should exist after buy");
            ...
            assertFalse(positions.containsKey(positionKey),
        ...
        void testPositionUpdatedWhenPartiallySold() {
            ...
            String positionKey = "1::AAPL";
            Position originalPosition = positions.get(positionKey);
            ...
            Position updatedPosition = positions.get(positionKey);
    ...
    class EdgeCaseTests {
        ...
        void testSellMinimumQuantity() {
            ...
            assertFalse(positions.containsKey("1::AAPL"),
        ...
        void testSellMultipleSymbolsIndependently() {
            ...
            assertFalse(positions.containsKey("1::AAPL"), "AAPL position should be removed");

            // MSFT position should still exist
            assertTrue(positions.containsKey("1::MSFT"), "MSFT position should still exist");
            assertEquals(50, positions.get("1::MSFT").getQuantity(), "MSFT quantity should be unchanged");
        }
    }
}
